...
public class DeleteFavoriteHandler extends BaseHandler implements HttpHandler {
    public final IFavoriteService service;

    public DeleteFavoriteHandler(IFavoriteService service) {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        String responseMessage = service.removeMediaFromFavorites(user, media_id);
        ...
        if (responseMessage.equals("success")) {
            responseObject.put("message", "Media entry removed from favorites successfully");
